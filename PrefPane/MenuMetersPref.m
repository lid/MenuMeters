...
- (IBAction)memPrefChange:(id)sender {
	...
	} else if (sender == memPagerateColor) {
		[ourPrefs saveMemPagerateColor:[memPagerateColor color]];
	}
	...
	[memPagerateColor setColor:[ourPrefs memPageRateColor]];
