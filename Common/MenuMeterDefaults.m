...
- (NSColor *)memPageRateColor {
	return [self loadColorPref:kMemPageRateColorPref defaultValue:kMemPageRateColorDefault];
} // memPagerateColor
...
- (void)saveMemPagerateColor:(NSColor *)color {
	[self saveColorPref:kMemPageRateColorPref value:color];
} // saveMemPagerateColor
...
- (NSColor *)loadColorPref:(NSString *)prefName defaultValue:(NSColor *)defaultValue {
	...
	NSColor *returnValue = defaultValue;
