...
#define kMemVMPageInfoMenuIndex				6
#define kMemVMCacheInfoMenuIndex			7
#define kMemVMFaultInfoMenuIndex			8
#define kMemSwapCountInfoMenuIndex			10
#define kMemSwapMaxCountInfoMenuIndex		11
#define kMemSwapSizeInfoMenuIndex			12
...
#define kMemPageRateColorPref				@"MemPageRateColor"
